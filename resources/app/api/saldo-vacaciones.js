export default {
    obtenerTodas(cb, errorCb) {
        axios.get('rrhh/saldo-vacacion/obtener-todas')
    ...
    obtener(data, cb, errorCb) {
        axios.post('rrhh/saldo-vacacion/obtener', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    obtenerSaldo(data, cb, errorCb) {
        axios.post('rrhh/saldo-vacacion/obtener-saldos', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
