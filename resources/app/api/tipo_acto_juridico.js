export default {
    obtenerTodas(cb, errorCb) {
        axios.get('tipo-acto-juridico/obtener-todas')
    ...
    obtener(data, cb, errorCb) {
        axios.post('tipo-acto-juridico/obtener', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
    ...
    obtenerActoJuridico(data, cb, errorCb) {
        axios.post('tipo-acto-juridico/obtener-tipo', data)
        .then(function (response) {
            if (response.data.status == 'success') {
                cb(response.data.result)
            } else {
