	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar Tipos de Notas de Crédito</div>
				<div class="box-description">Listado de tipos de Notas de Crédito</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-cuentas-cobrar' }"> Módulo cuentas por cobrar</router-link>> Tipos Notas de Crédito</div>

			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-tipo-nota-credito' }">
					...
					<tbody>
						<tr v-for="tipo_nota_credito in tipos_nota_credito" :key="tipo_nota_credito.id_tipo_nota_credito">
							...
							<td class="text-center">
								...
								<router-link tag="a" :to="{ name: 'actualizar-tipo-nota-credito', params: { id_tipo_nota_credito: tipo_nota_credito.id_tipo_nota_credito } }"><i class="icon-pencil"></i></router-link>
								<!--</template>-->
							</td>
						</tr>
...
<script type="text/ecmascript-6">
	import tipos_notas from '../../api/tipos_notas_credito'
