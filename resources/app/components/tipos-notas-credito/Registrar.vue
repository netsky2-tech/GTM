			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Crear Nuevo Tipo de Nota de Crédito</div>
						<div class="box-description">Formulario para registrar nuevo tipo de Nota de Crédito</div>
					</div>
					<form>
						...
						<div class="form-group">
							<label class="check-label2"><input v-model="form.aplica_comision"
															   type="checkbox"> Aplica comisión</label>
						</div>
					</form>
					<div class="content-box-footer text-right">
						<router-link tag="button" :to="{ name: 'tipos-notas-credito' }">
