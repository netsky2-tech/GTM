	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar grupo de lista de precio</div>
				<div class="box-description">Listado de grupos</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-ventas' }"> Módulo venta</router-link>> Grupo lista de precio</div>
			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link :to="{ name: 'registrar-lista-grupo' }" class="btn btn-success" tag="button">
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="lista.id_precio_lista_catalogo" v-for="lista in listas">
							...
							<td>{{ lista.lista_tipo_producto.descripcion }}</td>
							<td class="text-center">
							 <div v-if="lista.activo">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-lista-grupo', params: { id_precio_lista_grupos: lista.id_precio_lista_grupos } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
