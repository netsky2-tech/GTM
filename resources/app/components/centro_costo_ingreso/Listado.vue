	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar Zonas de costo</div>
				<div class="box-description">Listado de zonas de costo</div>
			</div>
			<div class="row">
				<div class="col-md-4 sm-text-center">
					<router-link :to="{ name: 'registrar-centro-costo' }" class="btn btn-success" tag="button">
						<i class="pe-7s-plus"></i> Registrar zona de costo
					</router-link>
				</div>
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="centro.id_centro" v-for="centro in centros">
							<template v-if="centro.tipo_centro === 2">
								<td>Zona de costos</td>
							</template>
							<template v-else>
							...
							<template v-if="centro.ubicacion === 1">
							<td>General</td>
							</template>
							<td class="text-center">
							 <div v-if="centro.estado">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-centro-costo', params: { id_centro: centro.id_centro } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
			...
			<pagination :items="centros" :limit="filter.limit" :limitOptions="filter.limitOptions" :page="filter.page" :total="total" @changeLimit="changeLimit" @changePage="changePage"></pagination>
...
<script type="text/ecmascript-6">
	...
	import centro_costo from "../../api/centro_costo";
		...
		methods: {
			...
			downloadItem (ext) {
				...
				if(!this.descargando){
					...
					axios.get('contabilidad/centro-costo/reporte/'+ext, { responseType: 'blob' })
							.then(({ data }) => {
