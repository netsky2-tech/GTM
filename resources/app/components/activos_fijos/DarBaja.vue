    ...
    <div class="main">
        ...
        <div class="content-box">
            <div class="content-box-header">
                <div class="box-title">Dar de Baja Activo Fijo</div>
                <div class="box-description">Formulario para dar de baja activo fijo</div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <v-select
                                    :disabled="true"
                                    v-model="form.activo_sucursal"
                                    label="descripcion"
                                    :options="sucursales"
                            ></v-select>
                            <ul class="error-messages">
                                <li v-for="message in errorMessages.activo_sucursal" :key="message" v-text="message"></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" v-model="form.justificacion" placeholder="Dígite la justificacion de la baja del activo">
                            <ul class="error-messages">
                                <li v-for="message in errorMessages.justificacion" :key="message" v-text="message"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="content-box-footer text-right">
                        ...
                        <template v-if="form.estado===1">
                            <button @click="desactivar" class="btn btn-danger"><i
                                    class="fa fa-trash-o"> Dar de Baja</i></button>
                        </template>
                    </div>
                </div>
