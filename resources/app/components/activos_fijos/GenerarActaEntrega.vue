    ...
    <div class="main">
        ...
        <div class="content-box">
            <div class="content-box-header">
                <div class="box-title">Actas de entrega</div>
                <div class="box-description">Formulario para generar acta de entrega</div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box-footer text-right">
                        ...
                        <button :disabled="btnAction !== 'Generar'" @click="descargarActaEntrega"
