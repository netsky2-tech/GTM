	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar comprobantes</div>
				<div class="box-description">Listado de comprobantes</div>
			...
			<div class="row">
				<div class="col-sm-2 sm-text-center">
					<router-link :to="{ name: 'registrar-comprobante' }" class="btn btn-success" tag="button">
						<i class="pe-7s-plus"></i> Registrar comprobante
					</router-link>
				</div>
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							<th>Número</th>
							<th>Concepto</th>
							<th class="text-center">Monto entregado</th>
					...
					<tbody>
						<tr :key="comprobante.id_comprobante" v-for="comprobante in comprobantes">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-comprobante', params: { id_comprobante: comprobante.id_comprobante } }" tag="a"><i class="icon-pencil"></i></router-link>
								<a :disabled="descargando" @click.prevent="downloadItem('pdf',comprobante.id_comprobante)"><i aria-hidden="true" class="fa fa-eye"></i></a>
							</td>
						</tr>
...
<script type="text/ecmascript-6">
	...
	export default {
		...
		methods: {
			...
			downloadItem(extension, id_comprobante) {
				var self = this;
				if (!this.descargando) {
					self.loading = true;
					let url = 'modulo-tesoreria/caja-chica-comprobante/reporte/' + id_comprobante;
