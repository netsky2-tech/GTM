			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Crear Nuevo tipo de bodega</div>
						<div class="box-description">Formulario para registrar tipo de bodega</div>
					</div>
					<form>
						<div class="form-group">
							<label for=""> Descripcion</label>
							<input class="form-control" placeholder="Dígite el tipo de bodega" v-model="form.descripcion">
	...
	export default {
		...
		methods: {
			registrar() {
				...
				self.loading = true;
				tipoBodega.registrar(self.form, data => {
					self.loading = false;
