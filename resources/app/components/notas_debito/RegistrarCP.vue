        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <typeahead :initial="form.nota_debito_proveedor" :params="{es_deudor: false}" :trim="80" :url="proveedoresBusquedaURL"
                                               @input="seleccionarProveedor" style="width: 100%;"></typeahead>
                                </div>
                                <ul class="error-messages">
                                    <li :key="message" v-for="message in errorMessages.nota_debito_proveedor"
                                        v-text="message"></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <v-select
                                        :options="monedas"
                                        label="descripcion"
                                        v-model="form.nota_debito_moneda"
                                        v-on:change="limpiar"
                                ></v-select>
                                <ul class="error-messages">
                                    <li :key="message" v-for="message in errorMessages.nota_debito_moneda"
                                        v-text="message"></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div v-if="!form.nota_debito_proveedor">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <label > Monto (<strong>{{form.nota_debito_moneda?form.nota_debito_moneda.descripcion:"N/A"}}</strong>)</label>
                                <input :disabled="!form.nota_debito_moneda" class="form-control" placeholder="Monto" @change="calcular_monto"   v-model.number="detalleForm.monto">
                        ...
                        <div class="col-sm-12">
                            ...
                            <table class="table table-bordered"  >
                                ...
                                <tr>
                                    ...
                                    <th>Tipo N/C</th>
                                    <th>Descripción</th>
                                    <th>Monto {{form.nota_debito_moneda?form.nota_debito_moneda.descripcion:"N/A"}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                <template v-for="(item, index) in form.detalleFacturas">
                                    <tr>
                                        ...
                                        <td style="width: 10%">
                                            <input class="form-control" disabled v-model="item.nota_debito_factura.numero_factura">
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td  class="text-center">
                                        <strong><strong>{{form.nota_debito_moneda?form.nota_debito_moneda.codigo:"N/A"}}</strong> {{total_cargo|formatMoney(2)}}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                    ...
                                    <td  class="text-center">
                                        <strong>{{form.nota_debito_moneda?form.nota_debito_moneda.codigo:"N/A"}} {{form.monto_total_iva|formatMoney(2)}}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                    <td class="text-right"> <strong> SubTotal </strong></td>
                                    <td  class="text-center">
                                        <strong>{{form.nota_debito_moneda?form.nota_debito_moneda.codigo:"N/A"}} {{form.monto_total|formatMoney(2)}}</strong>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="content-box-footer text-right">
                        <router-link :to="{ name: 'notas-debito-cp' }" tag="button">
...
<script type="text/ecmascript-6">
    import notas_debito from "../../api/notas_debito_cp";
        ...
        methods: {
            ...
            calcular_monto(){
                ...
                if(self.form.nota_debito_moneda && self.detalleForm.nota_debito_factura){
                    let tasax = 1;
                    let monto_maximo = Number(self.detalleForm.nota_debito_factura.total);
                        ...
                        if(validacion===0){
                            ...
                            if (self.form.detalleFacturas) {
                                self.form.detalleFacturas.forEach((cuentax, key) => {
                                    if (
                                        (self.detalleForm.nota_debito_factura.identificador === cuentax.nota_debito_factura.identificador)
                                        && (self.detalleForm.nota_debito_factura.tipo === cuentax.nota_debito_factura.tipo)
                                    ) {
                                        i++;
                                        keyx = key;
                                    }
                            ...
                            if (i === 0) {
                                ...
                                if(self.detalleForm.monto === Number(self.detalleForm.nota_debito_factura.total)){
                                    descripcionx = 'Hemos debitado a la cuenta del proveedor el monto total de la factura No.'+self.detalleForm.nota_debito_factura.numero_factura+', por concepto de: '+self.detalleForm.nota_debito_tipo.descripcion;
                                }else{
                                    descripcionx = 'Hemos debitado a la cuenta del proveedor el monto parcial de la factura No.'+self.detalleForm.nota_debito_factura.numero_factura+', por concepto de: '+self.detalleForm.nota_debito_tipo.descripcion;
                                }
            ...
            seleccionarProveedor(e) {
                ...
                notas_debito.obtenerFacturasCompraProveedor({
