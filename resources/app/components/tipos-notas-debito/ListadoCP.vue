	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				...
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-cuentas-pagar' }"> Módulo cuentas por pagar</router-link>> Tipos Notas de Débito</div>

			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-tipo-nota-debito-cp' }">
					...
					<tbody>
						<tr v-for="tipo_nota_debito in tipos_nota_debito" :key="tipo_nota_debito.id_tipo_nota_debito">
							...
							<td class="text-center">
								...
								<router-link tag="a" :to="{ name: 'actualizar-tipo-nota-debito-cp', params: { id_tipo_nota_debito: tipo_nota_debito.id_tipo_nota_debito } }"><i class="icon-pencil"></i></router-link>
								<!--</template>-->
							</td>
						</tr>
