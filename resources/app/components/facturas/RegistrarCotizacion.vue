      ...
      <div class="col-md-12">
        <div class="content-box">
          <div class="content-box-header">
            <div class="box-title">Registrar Cotización </div>
            <div class="box-description">Formulario para registrar Cotización</div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="check-label2"><input type="checkbox"
                                                   v-model="form.es_nuevo"> Cliente Nuevo</label>
              </div>
            </div>
            ...
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <input type="text" class="form-control" v-model="form.nombre_razon">
                <ul class="error-messages">
                  <li
                          :key="message"
                          v-for="message in errorMessages.nombre_razon"
                          v-text="message"
                  ></li>
                </ul>
              </div>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <select v-on:change="cambiarMascara" class="form-control" v-model.number="form.tipo_identificacion">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control" v-mask="mascara" placeholder="Número Identificación" v-model="form.identificacion">
                <ul class="error-messages">
          ...
          <br>
           <div class="content-box-footer text-right">
            <router-link tag="button" :to="{ name: 'listado-cotizaciones' }">
              <button type="button" class="btn btn-default">Cancelar</button>
            </router-link>
            <button :disabled="btnAction !== 'Registrar Cotización'"
                    @click="registrar"
...
<script type="text/ecmascript-6">
  ...
  import proforma from "../../api/proformas";
