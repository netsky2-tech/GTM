  ...
  <div class="main">
    <div class="content-box">
      <div class="content-box-header">
        <div class="box-title">Facturas de Exportación</div>
        <div class="box-description">Listado de Facturas de Exportación</div>
        <div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-caja' }"> Módulo Caja y Banco</router-link>> Facturación de Exportación</div>
      </div>
      <div class="row">
        <div class="col-md-6 sm-text-center">
          <router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-factura-exportacion' }">
              ...
              <tr :key="factura.id_factura">
                ...
                <td class="text-center">
                  <a :disabled="descargando"
                     @click.prevent="downloadItem('pdf',factura.id_factura_exportacion)"><i aria-hidden="true"
                                                                                        class="fa fa-eye"></i></a>
...
export default {
  ...
  methods: {
    ...
    downloadItem(extension, id_importacionx) {
      var self = this;
        self.loading = true;
        let url = 'inventario/facturas-exportacion/reporte/' + extension + '/' + id_importacionx;
