      ...
      <div class="col-md-12">
        <div class="content-box">
          <div class="content-box-header">
            ...
            <div class="box-description">Formulario para facturar productos consignados</div>
          </div>
              ...
              <table class="table table-bordered"  >
                ...
                <template v-for="(item, index) in form.detalleProductos">
                  <tr>
                    ...
                    <td style="width: 5%">
                      <input :disabled="true" class="form-control" v-model.number="item.p_descuento" @change="item.p_descuento = Math.max(Math.min(Math.round(item.p_descuento), 20), 0)">
                      <ul class="error-messages">
                        <li
                                :key="message"
  ...
  /*
     ...
     procesar_factura(){
       ...
       self.$swal.fire({
         ...
         if (result.value) {
           factura.registrarFacturaConsignacion(
                   self.form,
                   data => {
                     this.$swal.fire(
                             'Factura Registrada!',
