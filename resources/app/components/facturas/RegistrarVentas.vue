        ...
        <div class="content-box">
            ...
            <div class="col-sm-5">
              <div class="form-group">
                <div class="form-group">
                  ...
                  <select @change="seleccionarSucursal" class="form-control" v-model="form.factura_sucursal">
                    <option :key="sucursal.id_sucursal" :value="sucursal" v-for="sucursal in sucursales">{{ sucursal.descripcion}}
                    </option>
                  </select>
                </div>
                <ul class="error-messages">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="check-label2"><input @input="deseleccionar"
                                                   v-model="form.proforma_especifica" type="checkbox"> Tiene proforma</label>
              </div>
            </div>
            <div class="col-sm-10">
              <div class="form-group">
                ...
                <div class="form-group">
                  <typeahead v-if="form.proforma_especifica" :initial="form.proformasBusqueda" :trim="80" :url="proformasBusquedaURL" @input="seleccionarProforma" style="width: 100%;"></typeahead>
                  <input v-if="!form.proforma_especifica" class="form-control" disabled>
                </div>
                <ul class="error-messages">
                  <li :key="message" v-for="message in errorMessages.proformasBusqueda" v-text="message"></li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label for>&nbsp;</label>
                <button @click="agregarDetalle" class="btn btn-info" ref="agregar">Agregar Producto</button>
              </div>
            </div>
            ...
            <div class="col-sm-12">
              ...
              <table class="table table-bordered table-hover table-responsive"  >
                ...
                <tr>
                  ...
                  <th style="min-width:120px">Afectación</th>
                  <th >% Ajuste</th>
                  <th style="min-width:50px">Cantidad</th>
                  <!-- <th >U/M</th>-->
                  <th style="min-width:150px">P. Lista C$</th>
                  <th style="min-width:150px">P. Unitario C$</th>
                  <th >Descuento %</th>
                  <th style="min-width:150px">Descuento C$</th>
                  <th style="min-width:150px">Ajuste C$</th>
                  <th style="min-width:150px">Precio Unit. C$</th>
                  <!--<th >Monto IVA U$</th>-->
                  <th style="min-width:150px">Valor C$</th>
                </tr>
                </thead>
                <tbody>
                <template v-for="(item, index) in form.detalleProductos">
                  <tr>
                    ...
                    <td style="width: 5%">
                      <input class="form-control" v-model.number="item.precio_vendedor" @change="calcular_descuento(item)">
                      <ul class="error-messages">
                        <li
                                :key="message"
                    ...
                    <td style="width: 8%">
                      <strong>C$ {{item.mt_descuento| formatMoney(2)}}</strong>
                    </td>
                ...
                <tr>
                  ...
                  <td><label class="check-label"><input :disabled="form.id_tipo===2" v-model="form.aplicaIR"
                ...
                <tr>
                  ...
                  <td><label class="check-label"><input :disabled="form.id_tipo===2" v-model="form.aplicaIMI"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      calcular_descuento(itemX){
        itemX.precio_vendedor = Math.max(Math.min(Number(itemX.precio_vendedor.toFixed(2)), Number(itemX.precio.toFixed(2))), 0);
        itemX.p_descuento = Number((1-((itemX.precio_vendedor/itemX.precio).toFixed(4)))*100);
      },
      calcular_montos(itemX){

        //itemX.mt_ajuste
        itemX.mt_descuento= Number((Number(((Number((itemX.precio-itemX.precio_vendedor))* Number(itemX.cantidad))).toFixed(2))).toFixed(2));
        ...
        */
        ...
        if(!isNaN(itemX.p_descuento)){
          return itemX.p_descuento;
        }
        else return 0;
      },
            ...
            if(i === 0){
              if(cantidad <= Number(self.detalleForm.productox.cantidad_disponible)){
                self.form.detalleProductos.push({
                  ...
                  precio_vendedor: Number(self.detalleForm.precio_sugerido),
                  p_descuento:  0,
                  mt_descuento:  0,
