          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <ul class="error-messages">
                  <li v-for="message in errorMessages.no_documento" :key="message" v-text="message"></li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <datepicker  :format="format" :language="es" @selected="onDateSelect" @change="obtenerTC" :value="new Date()"></datepicker>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label for>T/C</label>
                <input disabled type="text" class="form-control" v-model="form.t_cambio" @change="obtenerTC">
              </div>
            </div>
              ...
              <table class="table table-bordered table-hover table-responsive"  >
                ...
                <template v-for="(item, index) in form.detalleProductos">
                  <tr>
                    ...
                    <td style="width: 5%">
                      <input :disabled="item.p_ajuste>0" class="form-control" v-model.number="item.p_descuento" @change="item.p_descuento = Math.max(Math.min(Math.round(item.p_descuento), 50), 0)">
                      <ul class="error-messages">
                        <li
                                :key="message"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    tc.obtenerTCParalela({
      ...
      onDateSelect(date) {
        this.form.f_factura = moment(date).format("YYYY-MM-DD"); //
      },
      ...
      nueva() {
        var self = this;
        factura.nueva({id_sucursal:self.id_sucursal
                }, data => {
