      ...
      <div class="col-md-12">
        <div class="content-box">
          <div class="content-box-header">
            <div class="box-title">Facturar baterías sin garantía</div>
            <div class="box-description">Formulario para facturar baterías sin garantía (obsoletas y recuperadas)</div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label for>Tipo de Producto a facturar</label>
                <select @change="seleccionarTipoProductos" class="form-control" v-model.number="form.tipo_venta">
              ...
              <table class="table table-bordered table-hover table-responsive"  >
                ...
                <template v-for="(item, index) in form.detalleProductos">
                  <tr>
                    ...
                    <td style="width: 5%">
                      <input :disabled="item.p_ajuste>0" class="form-control" v-model.number="item.p_descuento" @change="item.p_descuento = Math.max(Math.min(Math.round(item.p_descuento), 80), 0)">
                      <ul class="error-messages">
                        <li
                                :key="message"
  ...
  export default {
    ...
    methods: {
      seleccionarTipoProductos(){
        ...
        if(self.form.tipo_venta === 3){
          bodega.buscarProductosBodegaRecuperados({
        ...
        else if(self.form.tipo_venta === 4){
          bodega.buscarProductosBodegaObsoletos({
            id_bodega: self.form.factura_bodega.id_bodega
          }, data => {
            if(data !== null){
