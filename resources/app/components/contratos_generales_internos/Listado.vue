	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar información de datos de escritura empresa</div>
				<div class="box-description">Listado de contratos</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-inventario' }"> Módulo inventario</router-link>> Contrato interno</div>
			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link :to="{ name: 'registrar-contrato-interno' }" class="btn btn-success" tag="button">
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="contratos.id_contrato_dgeneral_interno" v-for="contrato in contratos">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-contrato-interno', params: { id_contrato_dgeneral_interno: contrato.id_contrato_dgeneral_interno } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
