    ...
    <div class="main">
        <div class="content-box">
            <div class="content-box-header">
                <div class="box-title">Modificar un colaborador</div>
                <div class="box-description">Formulario para modificar datos de un colaborador</div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" disabled v-model="form.trabajador_detalles.sexo">
