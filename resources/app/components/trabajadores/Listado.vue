	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Control de colaboradores</div>
				<div class="box-description">Listado de colaboradores</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-administracion' }"> Módulo administración</router-link>> Colaboradores</div>
			</div>
			<div class="row">
				<div class="col-md-4 sm-text-center">
					<router-link :to="{ name: 'registrar-trabajador' }" class="btn btn-primary" tag="button">
						<i class="pe-7s-plus"></i> Registrar Nuevo colaborador
					</router-link>
				</div>
