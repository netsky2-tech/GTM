	...
	<div class="main">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Registrar nuevo colaborador</div>
						<div class="box-description">Formulario de nuevo colaborador</div>
					</div>


						<vue-tabs>
							<v-tab title="Datos generales del colaborador">
								<br>
								<div class="row">
								...
								<div class="row">
									<!--<div class="col-sm-4">
										<div class="form-group">
											<label for>Imagen colaborador</label>
											<div class="uploader">
												<button
