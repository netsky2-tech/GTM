    ...
    <div class="row">
      <div class="col-md-12">
        <div class="content-box">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" type="number" v-model.number="form.ssa">
                </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.spe">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.tsi">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" readonly type="number" v-model.number="form.isc">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" readonly type="number" v-model.number="form.dai">
                </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.iva">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
          ...
          <div class="alert alert-success">
            <span><strong>Agencia Aduanera / Flete / Seguro / Costos de Transporte </strong></span>
          </div>
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.flete">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.seguro">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.subtotal_agencia_aduanera">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.iva_agencia_aduanera">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.nota_credito_agencia">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.costo_transporte">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">$</div>
                  <input class="form-control" type="number" v-model.number="form.nota_debito_transporte">
                </div>
                <ul class="error-messages">
                  <li
                          :key="message"
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control" type="number" v-model.number="detalleForm.cantidad">
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control" type="number" v-model.number="detalleForm.peso">
                <ul class="error-messages">
                  <li
                          :key="message"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" type="number" v-model.number="detalleForm.valor_unitario">
                </div>
            ...
            <div class="col-sm-12">
              ...
              <table class="table table-bordered table-hover table-responsive"  >
                ...
                <tr>
                  ...
                  <th style="min-width:100px">Peso Unitario Kg</th>
                  <th style="min-width:100px">Peso Total Kg</th>
                  <th style="min-width:100px">Valor Unitario</th>
                  ...
                  <th style="min-width:100px">Flete / Seguro</th>
                  ...
                  <th style="min-width:150px">Costo Transporte</th>
                  <th style="min-width:100px">Nota Débito Transporte</th>
                  <th style="min-width:250px">Costo Nuevo + Costo Transporte</th>
                ...
                <template v-for="(item, index) in form.detalleProductos">
                  <tr>
                    ...
                    <td>
                      <strong>{{valor_peso_unitx(item)}}</strong>
                    </td>
                    ...
                    <td>
                      <input  class="form-control" type="number" v-model.number="item.valor_unitario">
                      <ul class="error-messages">
                        <li
                                :key="message"
                    ...
                    <td>
                      <strong>$ {{flete_segurox(item)| formatMoney(2)}}</strong>
                    </td>
                ...
                <tr>
                  ...
                  <td class="item-footer" style="width: 14%">
                    <strong>$ {{total_fs | formatMoney(2)}}</strong>
                  </td>
                  <td class="item-footer" style="width: 14%">
 ...
 // import Typeahead from '../layout/Typeahead'
  export default {
    ...
    computed: {
      ...
      total_peso() {
        return this.form.detalleProductos.reduce((carry, item) => {
                  this.total_pesox = (carry + Number(item.peso));
      ...
      total_fob() {
         return this.form.detalleProductos.reduce((carry, item) => {
           this.total_fobx = (carry + Number(item.valor_fobx));
    ...
    methods: {
      ...
      total_cordobasx(itemX) {
        itemX.total_cordobasx=  Number((Number(itemX.costo_nuevo_con_transportex)+Number(itemX.ssax)+ Number(itemX.spex)+  Number(itemX.tsix)+  Number(itemX.dai_cordx)+  Number(itemX.isc_cordx)
