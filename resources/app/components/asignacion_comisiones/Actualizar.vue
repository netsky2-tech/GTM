      ...
      <div class="col-md-12">
        <div class="content-box">
          <div class="content-box-header">
            ...
            <div class="box-description">Formulario para actualizar comisiones por vendedor</div>
            <div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-ventas' }"> Módulo Ventas</router-link>> Actualización Comisión Vendedores</div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
               ...
               <input type="text" readonly class="form-control" v-model="form.nombre_completo">
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-12">
              ...
              <table class="table table-bordered"  >
                ...
                <template v-for="(item, index) in form.comisiones_asignadas">
                  <tr>
                    <td>
                      <input class="form-control" disabled v-model="item.comision_marca.descripcion">
                      <ul class="error-messages">
                        <li
                                :key="message"
                                v-for="message in errorMessages[`comisiones_asignadas.${index}.comision_marca.id_marca`]"
                                v-text="message">
                        </li>
                      </ul>
                    </td>
                    ...
                    <td v-if="item.tipo_meta===1">
                      ...
                      <ul class="error-messages">
                        <li
                                :key="message"
                                v-for="message in errorMessages[`comisiones_asignadas.${index}.meta_unidades`]"
                                v-text="message">
                        </li>
                      </ul>
                    </td>
                    <td v-if="item.tipo_meta===2">
                      ...
                      <ul class="error-messages">
                        <li
                                :key="message"
                                v-for="message in errorMessages[`comisiones_asignadas.${index}.meta_monto`]"
                                v-text="message">
                        </li>
                      </ul>
                    </td>
                    ...
                    <td>
                      ...
                      <ul class="error-messages">
                        <li
                                :key="message"
                                v-for="message in errorMessages[`comisiones_asignadas.${index}.porcentaje_comision_sobremeta`]"
                                v-text="message">
                        </li>
                      </ul>
                    </td>
...
console.log('cargarMarcas')
        if(self.form.vendedor){
          self.marcas.forEach((comision_marca, key) => {
