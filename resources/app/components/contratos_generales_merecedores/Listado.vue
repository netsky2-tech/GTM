	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar información de datos escritura consignatario</div>
				<div class="box-description">Listado de datos escritura consignatario</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-inventario' }"> Módulo inventario</router-link>> Contrato merecedor</div>
			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link :to="{ name: 'registrar-contrato-merecedor' }" class="btn btn-success" tag="button">
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th>Caracter cargo</th>
							<th>Caracter legal</th>
							<th>Identificación</th>
							<th>Fecha inscripción escritura</th>
						<!--	<th class="text-center table-number">Estado</th>-->
							<th class="text-center action">Opciones</th>
						</tr>
					</thead>
					<tbody>
						<tr :key="contratos.id_contrato_dgeneral_merecedor" v-for="contrato in contratos">
							<td>{{ contrato.nombre_representante }}</td>
							<td>{{ contrato.caracter_cargo }}</td>
							<td>{{ contrato.caracter_legal }}</td>
							<td>{{ contrato.no_identificacion }}</td>
							<td>{{ formatDate(contrato.fecha_inscripcion) }}</td>
							<!--<td class="text-center">
							 <div v-if="zona.activo">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-contrato-merecedor', params: { id_contrato_dgeneral_merecedor: contrato.id_contrato_dgeneral_merecedor } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
