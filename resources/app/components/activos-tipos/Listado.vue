	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar Tipos Activos</div>
				<div class="box-description">Listado de Tipos Activos</div>
			...
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link :to="{ name: 'registrar-tipo-activo' }" class="btn btn-success" tag="button">
						<i class="pe-7s-plus"></i> Registrar Tipo
					</router-link>
				</div>
				<div @keyup.enter="filter.page = 1;obtener();" class="col-md-6 sm-text-center form-inline justify-content-end">
					...
					<select class="form-control mb-1 mr-sm-1 mb-sm-0 search-field" v-model="filter.search.field">
						<option value="descripcion">Nombre Tipo</option>
					</select>
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="tipo.id_tipo_activo" v-for="tipo in tipos">
							<td>{{ tipo.descripcion }}</td>
							<td class="text-center">
							 <div v-if="tipo.activo">
							...
							<td class="text-center">
								...
								<router-link :to="{ name: 'actualizar-tipo-activo', params: { id_tipo_activo: tipo.id_tipo_activo } }" tag="a"><i class="icon-pencil"></i></router-link>
