	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar Zonas</div>
				<div class="box-description">Listado de Zonas</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-administracion' }"> Módulo administración</router-link>> Zonas</div>
			</div>
			<div class="row">
				<div class="col-md-3 sm-text-center">
					<router-link :to="{ name: 'registrar-zona' }" class="btn btn-success" tag="button">
						<i class="pe-7s-plus"></i> Registrar Zona
					</router-link>
				</div>
				<div @keyup.enter="filter.page = 1;obtener();" class="col-md-9 sm-text-center form-inline justify-content-end">
					...
					<select class="form-control mb-1 mr-sm-1 mb-sm-0 search-field" v-model="filter.search.field">
						<option value="descripcion">Zona</option>
					</select>
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="zona.id_zona" v-for="zona in zonas">
							<td>{{ zona.codigo }}</td>
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-zona', params: { id_zona: zona.id_zona } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
			...
			<pagination :items="zonas" :limit="filter.limit" :limitOptions="filter.limitOptions" :page="filter.page" :total="total" @changeLimit="changeLimit" @changePage="changePage"></pagination>
