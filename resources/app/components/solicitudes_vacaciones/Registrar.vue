				...
				<div class="content-box">
					<div class="content-box-header">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select :disabled="false" class="form-control mb-1 mr-sm-1 mb-sm-0 search-field" v-model="form.tipo_pago">
										<option value="1">Emisión de cheque</option>
										<option value="2">Pago en nómina</option>
									</select>
								</div>
							</div>
								<div class="col-sm-4">
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-3">
								<div class="form-group">
									<label for=""> Días a pagar</label>
									<input class="form-control" :disabled="false" type="number" min="0" v-model.number="form.dias_a_pagar" @change="form.dias_a_pagar = Math.max(Math.min(Math.round(form.dias_a_pagar), Number(form.trabajador.saldo_actual)), 1)">
									<ul class="error-messages">
										<li :key="message" v-for="message in errorMessages.dias_a_pagar" v-text="message"></li>
									</ul>
								</div>
							</div>
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input class="form-control" :disabled="true" v-model="calcularPagoVacaciones">
										<ul class="error-messages">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input :disabled="true" class="form-control" v-model="monto_letras">
										<ul class="error-messages">
