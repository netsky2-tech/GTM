    ...
    <div class="main">
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">Orden de Compra No. {{form.id_orden_compra}}</span>
                <div class="btn-group">
                    <a @click="regresar" style="margin-right: 10px;"> <i class="fa fa-arrow-left"></i> Regresar</a>
                    <a :disabled="descargando" @click.prevent="downloadItem('compras/ordenes/reporte/'+form.id_orden_compra)">  <i class="fa fa-download"></i> Descargar</a>
                </div>
            </div>
                ...
                <div class="document">
                    <div class="document-heading">
                        <div class="row">
                            <div class="col col-12 text-center">
                                ...
                                <div class="company-address"><strong>Orden de Compra No. {{form.id_orden_compra}}</strong></div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                    ...
                    <div class="document-body">
                        <table class="document-table">
                            ...
                            <tbody>
                            <template v-for="item in form.orden_compra_productos" >
                                <tr :key="item.id_orden_compra_producto">
                                    <td class="width-2">
                                        {{item.orden_compra_producto.codigo_sistema}}
                                    </td>
                                    <td class="width-2">
                                        <pre>{{item.orden_compra_producto.descripcion}}</pre>
                                    </td>
                                    <td class="width-2">
                                        {{item.orden_compra_producto.unidad_medida.unidad_medida}}
                                    </td>
                            ...
                            <tr>
                                <td colspan="4"></td>
                                <td colspan="2">Impuesto ({{form.porcentaje_iva}}%) {{form.orden_compra_moneda ? form.orden_compra_moneda.codigo : ''}}</td>
                ...
                if(!this.descargando){
                    ...
                    axios.get(url, { responseType: 'blob' })
                        .then(({ data }) => {
                            ...
                            link.download = 'ReporteOrdenCompra-'+this.form.id_orden_compra+'.pdf';
                            link.click()
