    ...
    <div class="content-box">
      ...
      <div class="row">
        <div class="col-md-6 sm-text-center">
          <router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-nota-credito' }">
          ...
          <tbody>
            <template v-for="(nota_credito,key) in notas_credito">
              <tr :key="nota_credito.id_nota_credito">
                ...
                <td>{{ nota_credito.nota_credito_cliente.nombre_comercial }}</td>
                ...
                <td class="text-center">
                  <router-link
                          ...
                          :to="{ name: 'mostrar-nota-credito', params: { id_nota_credito: nota_credito.id_nota_credito } }"
                          tag="a"
                  >
...
import nota_credito from "../../api/notas_credito";
