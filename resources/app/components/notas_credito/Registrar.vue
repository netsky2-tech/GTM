        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <typeahead :initial="form.nota_credito_cliente" :params="{es_deudor: false}" :trim="80" :url="clientesBusquedaURL"
                                               @input="seleccionarCliente" style="width: 100%;"></typeahead>
                                </div>
                                <ul class="error-messages">
                                    <li :key="message" v-for="message in errorMessages.nota_credito_cliente"
                                        v-text="message"></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div v-if="!form.nota_credito_cliente">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input @change="detalleForm.monto = detalleForm.nota_credito_factura? Math.max(Math.min(Number(!isNaN(detalleForm.monto)?detalleForm.monto.toFixed(2):0), Number(Number(detalleForm.nota_credito_factura.mt_total).toFixed(2))), 1):0"
                            ...
                            <table class="table table-bordered"  >
                                ...
                                <template v-for="(item, index) in form.detalleFacturas">
                                    <tr>
                                        ...
                                        <td style="width: 10%">
                                            <input class="form-control" disabled v-model="item.nota_credito_factura.no_documento">
                                        </td>
                    ...
                    <div class="content-box-footer text-right">
                        <router-link :to="{ name: 'notas-credito' }" tag="button">
...
<script type="text/ecmascript-6">
    import notas_credito from "../../api/notas_credito";
