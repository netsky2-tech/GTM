			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Registrar Departamento</div>
						<div class="box-description">Formulario para registrar Departamento</div>
					</div>
					<form>
	...
	export default {
		...
		methods: {
			registrar() {
				...
				self.loading = true;
				departamento.registrar(self.form, data => {
					self.loading = false;
