	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar tipo proveedores</div>
				<div class="box-description">Listado de Tipo de proveedores</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-inventario' }"> Módulo inventario</router-link>> Tipo proveedor</div>
			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link :to="{ name: 'registrar-tipo-proveedor' }" class="btn btn-success" tag="button">
						<i class="pe-7s-plus"></i> Registrar Tipo proveedor
					</router-link>
				</div>
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr :key="tipo.id_tipo_proveedor" v-for="tipo in tipos">
							...
							<td class="text-center">
								<router-link :to="{ name: 'actualizar-tipo-proveedor', params: { id_tipo_proveedor: tipo.id_tipo_proveedor } }" tag="a"><i class="icon-pencil"></i></router-link>
							</td>
						</tr>
		...
		methods: {
			...
			downloadItem (ext) {
				...
				if(!this.descargando){
					...
					axios.get('inventario/tipo-proveedor/reporte/'+ext, { responseType: 'blob' })
							.then(({ data }) => {
