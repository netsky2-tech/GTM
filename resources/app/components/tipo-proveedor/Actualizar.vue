	...
	<div class="main">
				...
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Modificar tipo proveedor</div>
						<div class="box-description">Formulario para modificar tipo de proveedor</div>
					</div>
					<form>
						<div class="form-group">
							<label for=""> Descripcion</label>
							<input class="form-control" placeholder="Dígite descripcion de proveedor" v-model="form.descripcion">
						...
						<div class="form-group">
							...
							<select class="form-control col-md-5" name="clasificacion_contable" v-model="form.clasificacion_contable" id="clasificacion_contable">
						...
						<div class="col-md-6">
							<div class="content-box-footer text-left">
								<template v-if="form.estado">
									<button @click="desactivar(form.id_tipo_proveedor)" class="btn btn-danger"><i class="fa fa-trash-o">	Eliminar</i></button>
								</template>
								<template v-else>
									<button @click="activar(form.id_tipo_proveedor)" class="btn btn-success"><i class="fa fa-check-square">	Habilitar</i></button>
								</template>
							</div>
						</div>
