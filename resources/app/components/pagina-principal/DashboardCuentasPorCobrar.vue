<template>
	<div class="main">
		<div class="simple-welcome-text">
			<div class="text">Módulo Cuentas Por Cobrar</div>
			<div class="box-description"><a @click="regresar" style="margin-right: 10px;"> Módulos</a>> Módulo Cuentas Por Cobrar</div>
		</div>
