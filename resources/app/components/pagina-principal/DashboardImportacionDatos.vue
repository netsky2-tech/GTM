<template>
	<div class="main">
		<div class="simple-welcome-text">
			<div class="text">Módulo de importación de datos</div>
			<div class="box-description"><a @click="regresar" style="margin-right: 10px;"> Módulos</a>> Módulo de importación de datos</div>
		</div>
