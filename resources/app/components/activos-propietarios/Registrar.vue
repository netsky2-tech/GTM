			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Registrar Propietario Activo</div>
						<div class="box-description">Formulario para registrar Propietario Activo</div>
					</div>
					<form>
						...
						<div class="form-group">
							<label for=""> Descripción Propietario Activo</label>
							<input class="form-control" placeholder="Dígite el código del Propietario Activo" v-model="form.descripcion">
							<ul class="error-messages">
