  ...
  <div class="main">
    <div class="content-box">
      <div class="content-box-header">
        ...
        <div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-cuentas-cobrar' }"> Módulo cuentas por cobrar</router-link>> Recibos</div>
      </div>
      <div class="row">
        <div class="col-sm-2 sm-text-center form-inline justify-content-start">
          <router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-recibo-oficial' }">
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <template v-for="(recibo,key) in recibos">
              <tr :key="recibo.id_recibo" @click="mostrarPagos(key)">
                <td class="detail-link">
                  <div v-tooltip="'Mostrar Detalle'" class="link"></div>
                </td>
                ...
                <td class="text-center">
                  <router-link
                          ...
                          :to="{ name: 'mostrar-recibo-oficial', params: { id_recibo: recibo.id_recibo } }"
                          tag="a"
                  >
