      ...
      <div class="col-md-12">
        <div class="content-box">
          <div class="content-box-header">
            <div class="box-title">Cambiar Estado de Comprobante de pago</div>
            <div class="box-description">Formulario para cambiar estado de comprobante de pago</div>
          </div>
...
<br>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input v-if="form.solicitud_cuenta_bancaria" class="form-control" disabled v-model="form.numero_comprobante_pago">
                        <ul class="error-messages">
                ...
                <div v-if="form.tipo_pago===2" class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input disabled class="form-control" v-model.number="form.correo_electronico_beneficiario">
                        <ul class="error-messages">
            ...
            <br>
            <div class="alert alert-success">
                <span>Datos de la persona que recibe comprobante</span>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Nombre persona recibe</label>
                        <input :disabled="!([6,7].indexOf(form.estado) >= 0)" class="form-control" v-model="form.nombre_persona_recibe">
                        <ul class="error-messages">
                            <li v-for="message in errorMessages.nombre_persona_recibe" :key="message" v-text="message"></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label >Número Identificación persona recibe</label>
                        <input :disabled="!([6,7].indexOf(form.estado) >= 0)" class="form-control" v-model="form.identificacion_persona_recibe">
                        <ul class="error-messages">
                            <li v-for="message in errorMessages.identificacion_persona_recibe" :key="message" v-text="message"></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="text-left">
                ...
                <div class="btn-group mr-2">
                    ...
                    <ul class="dropdown-menu">
                        <li v-if="([4].indexOf(form.estado) >= 0)"><a @click="cambiarEstado(5)">Cambiar a Firmado</a></li>
                        <li v-if="([5,7].indexOf(form.estado) >= 0)"><a @click="cambiarEstado(6)">Cambiar a Retenido</a></li>
                        <li v-if="([5,6].indexOf(form.estado) >= 0)"><a @click="cambiarEstado(7)">Cambiar a Disponible</a></li>
                        <li v-if="([7].indexOf(form.estado) >= 0)"><a @click="cambiarEstado(8)">Cambiar a Pagado</a></li>
                        <li v-if="([8].indexOf(form.estado) >= 0)"><a @click="cambiarEstado(9)">Cambiar a Archivado</a></li>
                    </ul>
                </div>
            </div>
  ...
  methods: {
    ...
    cambiarEstado(estadox) {
      ...
      self.btnAction = "Registrando, espere....";
          solicitud_pago.cambiarEstado(
              {
                  id_solicitud_pago:self.form.id_solicitud_pago,
                  estado:estadox,
                  nombre_persona_recibe:self.form.nombre_persona_recibe,
                  identificacion_persona_recibe:self.form.identificacion_persona_recibe,
      ...
      obtenerSolicitudCompleta() {
          ...
          solicitud_pago.obtenerSolicitudPago({
              ...
              if([4,5,6,7,8].indexOf(data.solicitud.estado) >= 0) {
                  self.form = data.solicitud;
                  self.form.nombre_persona_recibe='';
                  self.form.identificacion_persona_recibe='';
                  self.loading = false;
              }else{
