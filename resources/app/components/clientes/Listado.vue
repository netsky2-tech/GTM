  ...
  <div class="main">
    <div class="content-box">
      <div class="content-box-header">
        <div class="box-title">Administrar Clientes </div>
        <div class="box-description">Listado de Clientes</div>
        <div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-ventas' }"> Módulo ventas</router-link>> Clientes</div>
      </div>
      <div class="row">
            ...
            <tr v-for="cliente in clientes" :key="cliente.id_cliente">
              ...
              <td class="text-center">
                <!--<template v-if="[1].indexOf(cliente.id_cliente) < 0">-->
                  <router-link
                    tag="a"
                    :to="{ name: 'actualizar-cliente', params: { id_cliente: cliente.id_cliente } }"
                  >
