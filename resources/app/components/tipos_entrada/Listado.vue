	...
	<div class="main">
		<div class="content-box">
			<div class="content-box-header">
				<div class="box-title">Administrar Tipos de entrada</div>
				<div class="box-description">Listado de tipos de entrada</div>
				<div class="box-description"><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal' }">Módulos</router-link>><router-link :style="'margin-right: 10px;color: blue;'" :to="{ name: 'pagina-principal-inventario' }"> Módulo inventario</router-link>> Tipos de entrada</div>
			</div>
			<div class="row">
				<div class="col-md-6 sm-text-center">
					<router-link class="btn btn-success" tag="button" :to="{ name: 'registrar-tipo-entrada' }">
			...
			<div class="table-responsive mt-3">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr v-for="tipo in tipos" :key="tipo.id_tipo_entrada">
			...
			<pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipos" :total="total" :page="filter.page" :limitOptions="filter.limitOptions" :limit="filter.limit"></pagination>
		...
		methods: {
			...
			downloadItem (ext) {
				...
				if(!this.descargando){
					...
					axios.get('tipo-entrada/reporte/'+ext, { responseType: 'blob' })
							.then(({ data }) => {
