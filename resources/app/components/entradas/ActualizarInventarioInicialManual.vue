			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Actualizar entrada inicial</div>
							...
							<table class="table table-bordered"  >
								...
								<template v-for="(item, index) in form.entrada_productos">
									<tr>
										...
										<td>
											<input class="form-control" disabled v-model="item.entrada_producto.text">
											<ul class="error-messages">
												<li
														:key="message"
										...
										<td>
											<input  class="form-control" disabled v-model.number="item.entrada_presentacion.codigo">
											<ul class="error-messages">
												<li
														:key="message"
										...
										<td>
											<input  class="form-control" type="text" disabled v-model="item.entrada_presentacion.unidad_medida">
											<ul class="error-messages">
												<li
														:key="message"
										...
										<td>
											<input  class="form-control" type="text" disabled v-model="item.entrada_presentacion.simbolo_um">
											<ul class="error-messages">
												<li
														:key="message"
														v-for="message in errorMessages[`entrada_productos.${index}.cantidad`]"
										...
										<td>
											<input  class="form-control" type="number" min="1" disabled v-model.number="item.entrada_presentacion.escalar">
											<ul class="error-messages">
												<li
														:key="message"
														v-for="message in errorMessages[`entrada_productos.${index}.cantidad`]"
										...
										<!--<td>
											<input  class="form-control" type="number" min="1" disabled v-model.number="item.conversionx">
											<ul class="error-messages">
												<li
														:key="message"
														v-for="message in errorMessages[`entrada_productos.${index}.cantidad`]"
...
<script type="text/ecmascript-6">
	import conteox from "../../api/entradas-inventario-inicial";
		...
		computed: {
			...
			methods: {
				...
				cargarPresentaciones() {
					var self = this;
					self.loading = true;
					conteox.cargarPresentacionesProductos({
