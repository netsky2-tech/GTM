        ...
        <div class="content-box">
          ...
          <div class="row">
             <div class="col-sm-4">
              <div class="form-group">
               ...
               <input :disabled="btnActionBuscar != 'Buscar Entrada' ? true : false" type="text" class="form-control" v-model="form.entrada_original.codigo_entrada">
         ...
         <div class="col-sm-4">
              <div class="form-group">
                ...
                <input disabled type="text" class="form-control" v-model="form.entrada_original.entrada_bodega.nombre">
                <ul class="error-messages">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input disabled type="text" class="form-control"  v-model="form.entrada_original.entrada_proveedor.nombre_proveedor">
                <ul class="error-messages">
                  <li v-for="message in errorMessages.id_proveedor" :key="message" v-text="message"></li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label for>Código entrada</label>
                <input disabled type="text" class="form-control" v-model="form.entrada_original.codigo_entrada">
                <ul class="error-messages">
                  <li
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label for>Fecha entrada</label>
                 <input disabled type="text" class="form-control" v-model="form.entrada_original.fecha_entrada">
                <ul class="error-messages">
                  <li
                ...
                <tbody>
                  <template v-for="(item,index) in form.entrada_original.entradas_productos">
                    <tr :key="item.id_producto">
                      ...
                      <td style="width: 15%">
                        <input readonly type="number" class="form-control" v-model="item.precio_unitario">
                      </td>
                      <td style="width: 10%">
                          <span
