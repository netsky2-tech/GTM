			...
			<div class="col-md-12">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Editar minuta de depósito</div>
						<div class="box-description">Formulario para actualizar minuta de depósito</div>
					</div>
					<form>
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<v-select
											:options="sucursales"
											label="descripcion"
											v-model="form.sucursal_minuta"
									></v-select>
									<ul class="error-messages">
										<li
												:key="message"
												v-for="message in errorMessages.sucursal_minuta"
												v-text="message"
										></li>
									</ul>
								</div>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<v-select
											...
											label="numero_cuenta"
											v-model="form.cuenta_bancaria_minuta"
											v-on:input="seleccionarMoneda()"
									></v-select>
									<ul class="error-messages">
										<li :key="message" v-for="message in errorMessages.cuenta_bancaria_minuta" v-text="message"></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<input class="form-control" placeholder="Dígite el Numero de referencia" v-model="form.no_referencia">
									<ul class="error-messages">
										<li :key="message" v-for="message in errorMessages.no_referencia" v-text="message"></li>
									</ul>
								</div>
							</div>
							<div class="col-sm-3">
							...
							<div class="col-sm-3">
								<div class="form-group">
									<label for=""> TC</label>
									<input class="form-control" placeholder="Moneda de la cuenta bancaria"  readonly   v-model.number="form.tasa_cambio">
								</div>
							</div>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<input class="form-control" placeholder="Moneda de la cuenta bancaria"  readonly   v-model="form.moneda">
								</div>
							</div>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group">
										<div class="input-group-addon">{{form.moneda==='Córdobas'? "C$" :"$"}}</div>
										<input @change="calcularMontos" class="form-control" placeholder="Monto de la minuta"  type="number" v-model.number="monto_minuta">
									</div>
									<ul class="error-messages">
										<li :key="message" v-for="message in errorMessages.monto_minuta" v-text="message"></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="content-box-footer text-right">
						...
						<button :disabled="btnAction != 'Editar' ? true : false" @click="actualizar" class="btn btn-primary" type="button">{{ btnAction }}</button>
					</div>
...
<script type="text/ecmascript-6">
	...
	export default {
		...
		methods: {
			...
			seleccionarMoneda() {
				var self = this
				if(self.form.cuenta_bancaria_minuta.moneda_cuenta_bancaria)
			...
			actualizar() {
				...
				minuta.actualizar(self.form, data => {
			...
			obtenerMinuta() {
				...
				minuta.obtenerMinuta({
					...
					if (self.banco === ''){
						self.bancos.forEach((bancox, indice) => {
					...
					self.cuentas_bancarias.forEach((cuentax, indice) => {
