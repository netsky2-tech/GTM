        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-box">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <typeahead :initial="form.recibo_trabajador" :trim="80" :url="trabajadoresBusquedaURL"
                                               @input="seleccionarTrabajador" style="width: 100%;"></typeahead>
                                </div>
                                <ul class="error-messages">
                                    <li :key="message" v-for="message in errorMessages.recibo_trabajador"
                                        v-text="message"></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <ul class="error-messages">
                                    <li :key="message" v-for="message in errorMessages.fecha_emision" v-text="message"></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div v-if="!form.recibo_trabajador">
                        <div class="alert alert-info">
                            <span>Se requiere que seleccione un empleado para continuar.</span>
                        </div>
                        <hr>
                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input @change="detalleForm.monto = detalleForm.cuentax? Math.max(Math.min(Number(!isNaN(detalleForm.monto)?detalleForm.monto.toFixed(2):0), Number(Number(detalleForm.cuentax.saldo_actual).toFixed(2))), 1):0"
                                       class="form-control" ref="abono" type="number"
                        ...
                        <div class="col-sm-12">
                            ...
                            <table class="table table-bordered table-hover table-responsive"  >
                                ...
                                <tr>
                                    ...
                                    <th style="min-width:100px">Monto Abono C$</th>
                                    <th style="min-width:150px" colspan="2">Saldo Pendiente C$</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%">
                                            ...
                                            <ul class="error-messages">
                                                <li
                                                        :key="message"
                                                        v-for="message in errorMessages[`detalleCuentasxCobrar.${index}.descripcion_pago`]"
                                                        v-text="message">
                                                </li>
                                            </ul>
                                        </td>
                                        ...
                                        <td class="text-center" style="width: 12%">
                                            <input disabled class="form-control" v-model.number="item.monto_subtotal">
                                        </td>
                                        <td class="text-center" style="width: 12%">
                                        ...
                                        <td class="text-center" style="width: 12%">
                                            <input @change="establecerConcepto(item)"
                                                   class="form-control" v-model.number="item.monto">
                                            <ul class="error-messages">
                                                <li
                                                        :key="message"
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <template v-if="detalleFormPago.via_pagox">
                                    ...
                                    <div class="col-sm-6" v-if="[1,3,5,6].indexOf(detalleFormPago.via_pagox.id_via_pago) >= 0">
                                        <div class="form-group">
                                            <label > Banco</label>
                                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for>&nbsp;</label>
                                        <button @click="agregarMetodoPago" class="btn btn-info btn-agregar"
                    ...
                    <div class="content-box-footer text-right">
                        <router-link :to="{ name: 'recibos-oficiales-trabajador' }" tag="button">
    ...
    export default {
        ...
        methods: {
            ...
            seleccionarTrabajador(e) {
                ...
                self.form.nombre_persona = (self.form.recibo_trabajador.primer_nombre?self.form.recibo_trabajador.primer_nombre:'')
                    +(self.form.recibo_trabajador.segundo_nombre?' '+self.form.recibo_trabajador.segundo_nombre:'')
                    +(self.form.recibo_trabajador.primer_apellido?' '+self.form.recibo_trabajador.primer_apellido:'')
                    +(self.form.recibo_trabajador.segundo_apellido?' '+self.form.recibo_trabajador.segundo_apellido:'');
            ...
            registrar() {
                ...
                if (self.form.monto_total > 0 && self.form.pago_pendiente > 0) {
                    ...
                    self.$swal.fire({
                        ...
                        if (result.value) {
                            recibos.registrarROCTrabajador(
                                self.form,
                                data => {
                                    this.$swal.fire(
                                        'Recibo Registrado!',
