(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["productos~transformaciones"],{
...
/***/ "./resources/app/api/productopresentacion.js":
/*!***************************************************!*\
  !*** ./resources/app/api/productopresentacion.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  obtenerTodas: function obtenerTodas(cb, errorCb) {
    axios.get('producto-presentacion/obtener-productopresentacion-todas').then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  nuevo: function nuevo(data, cb, errorCb) {
    axios.post('producto_presentacion/nuevo', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  obtener: function obtener(data, cb, errorCb) {
    axios.post('producto-presentacion/obtener', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  obtenerProductoPresentacion: function obtenerProductoPresentacion(data, cb, errorCb) {
    axios.post('producto-presentacion/obtener-presentacion', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  registrar: function registrar(data, cb, errorCb) {
    axios.post('producto-presentacion/registrar', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  actualizar: function actualizar(data, cb, errorCb) {
    axios.put('producto-presentacion/actualizar', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  desactivar: function desactivar(data, cb, errorCb) {
    axios.put('producto-presentacion/desactivar', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
  ...
  activar: function activar(data, cb, errorCb) {
    axios.put('producto-presentacion/activar', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
