...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cargar_detalles_producto: function cargar_detalles_producto() {
      ...
      self.detalleForm.precio_sugerido = _assets_custom_scripts_Round__WEBPACK_IMPORTED_MODULE_7__["default"].round(Number(self.detalleForm.productox.precio_sugerido * self.form.tasa_paralela), 2);
      ...
      _api_tasas_cambio__WEBPACK_IMPORTED_MODULE_5__["default"].obtenerTCParalela({
        ...
        if (data.tasa_paralela !== null) {
          ...
          self.form.detalleProductos.forEach(function (productox, key) {
            ...
            productox.precio = Number((productox.precio_lista_me * self.form.tasa_paralela).toFixed(2)); // console.log(productox.precio_lista);T/C
          });
        } else {
...
/* harmony import */ var _api_marcadas__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../api/marcadas */ "./resources/app/api/marcadas.js");
/* harmony import */ var _api_caja_chica_comprobante__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../api/caja-chica-comprobante */ "./resources/app/api/caja-chica-comprobante.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    obtenerSeguimiento: function obtenerSeguimiento() {
      var _this = this;

      var self = this; //Array(1,2,3).includes(Number(self.$route.params.id_zona)) ? self.SoloLectura = true : self.SoloLectura = false

      _api_proformas_seguimiento__WEBPACK_IMPORTED_MODULE_0__["default"].obtenerProforma({
        id_proforma: this.$route.params.id_proforma
      }, function (data) {
        self.vendedores = data.vendedores;
    ...
    agregarDetalle: function agregarDetalle() {
      ...
      if (this.form.proximo_contacto) {
        ...
        if (self.form.proforma) {
          self.form.proforma.forEach(function (fila, key) {
  ...
  mounted: function mounted() {
    this.nueva(); //this.obtenerSeguimiento();
  }
});
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.form.no_documento,
                        expression: "form.no_documento"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { disabled: true, placeholder: "" },
                    domProps: { value: _vm.form.no_documento },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.form, "no_documento", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                ...
                _c(
                  ...
                  [
                    ...
                    _c("v-select", {
                      ...
                      model: {
                        value: _vm.form.proforma_vendedor,
                        callback: function($$v) {
                          _vm.$set(_vm.form, "proforma_vendedor", $$v)
                        },
                        expression: "form.proforma_vendedor"
                      }
                    }),
                    _vm._v(" "),
                    _c(
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      "tbody",
                      [
                        _vm._l(_vm.form.proforma, function(item, index) {
                          return [
                            _c("tr", [
                              _c("td", { staticStyle: { width: "2%" } }, [
                                _c(
                              ...
                              _c("td", [
                                _vm._v(
                                  "\n\t\t\t\t\t\t\t\t\t\t\t " +
                                    _vm._s(item.proforma_vendedor.text) +
                                    "\n\t\t\t\t\t\t\t\t\t\t\t"
                                ),
                                _c(
                                  "ul",
                              ...
                              _c("td", [
                                _c("input", {
                                  ...
                                  staticClass: "form-control",
                                  attrs: { disabled: true },
                                  domProps: { value: item.proximo_contacto },
                                  on: {
                                    input: function($event) {
                                      if ($event.target.composing) {
                                        return
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th"),
        _vm._v(" "),
        _c("th", { staticStyle: { "min-width": "330px" } }, [
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  obtenerProforma: function obtenerProforma(data, cb, errorCb) {
    axios.post('inventario/proformas-seguimiento/obtener-seguimiento', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
