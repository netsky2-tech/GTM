...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    generarSticker: function generarSticker(id_activox) {
      var self = this;
      var formato = 'pdf';
                    ...
                    _vm._l(_vm.activos_sucursal, function(activo_fijo, index) {
                      return _c("tr", { key: activo_fijo.id_activo }, [
                        ...
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              _vm.formatDate(activo_fijo.fecha_adquisicion)
                            )
                          )
                        ]),
                        _vm._v(" "),
                        ...
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(activo_fijo.meses_depreciarse))
                        ]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(
                    ...
                    !_vm.activos_sucursal.length
                      ? _c("tr", [
                          _c(
                            ...
                            [_vm._v("No ha seleccionado un periodo")]
                          )
                        ])
                      : _vm._e()
                  ],
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [_vm._v("Vista previa documento contable")]
                  )
                ],
                1
              )
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    "tbody",
                    [
                      _vm._l(_vm.doc_contable, function(documento, index) {
                        return _c("tr", { key: documento.id_cuenta_contable }, [
                          _c("td", [_vm._v(_vm._s(documento.cuentas))]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(documento.debe ? documento.debe : "0")
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(documento.haber ? documento.haber : "0")
                            )
                          ])
                        ])
                      }),
                      _vm._v(" "),
                      !_vm.doc_contable.length
                        ? _c("tr", [
                            _c(
                              "td",
                              {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "content-box-header" }, [
      _c("div", { staticClass: "box-title" }, [
        _vm._v("Generar Cierre de Activos")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "box-description" }, [
                ...
                _vm._l(_vm.activos_fijos, function(activo_fijo) {
                  return _c("tr", { key: activo_fijo.id_activo }, [
                    _c("td", [
                      _vm._v(
                        _vm._s(
                          activo_fijo.activo_centro
                            ? activo_fijo.activo_centro.descripcion
                            : "N/A"
                        )
                      )
                    ]),
                                ...
                                directives: [
                                  {
                                    name: "tooltip",
                                    rawName: "v-tooltip",
                                    value: "Generar Sticker de Código",
                                    expression: "'Generar Sticker de Código'"
                                  }
                                ],
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.generarSticker(
                                      activo_fijo.id_activo
                                    )
                                  }
                                }
