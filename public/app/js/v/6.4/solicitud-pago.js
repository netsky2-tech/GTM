  ...
  methods: {
    ...
    cambiarEstado: function cambiarEstado(estadox) {
      ...
      if (self.total_debe > 0 && self.total_haber > 0 && self.total_debe === self.total_haber) {
        //if(self.total_debe === self.form.valor){
        self.btnAction = "Registrando, espere....";
        _api_solicitudes_pago__WEBPACK_IMPORTED_MODULE_2__["default"].cambiarEstado({
              ...
              [
                ...
                _c(
                  "button",
                  {
                    ...
                    staticClass: "btn btn-primary",
                    attrs: {
                      disabled: _vm.btnAction !== "Confirmar Revisión",
                      type: "button"
                    },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "content-box-header" }, [
      _c("div", { staticClass: "box-title" }, [
        _vm._v("Revisión de Solicitud de pago")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "box-description" }, [
        _vm._v("Formulario para confirmar revisión de solicitud de pago")
      ])
    ])
  },
  function() {
              ...
              _c("div", { staticClass: "col-sm-6" }, [
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: {
                      disabled: !([6, 7].indexOf(_vm.form.estado) >= 0)
                    },
                    ...
                    ? _c("li", [
                        _c(
                          "a",
                          {
                            on: {
                              click: function($event) {
                                return _vm.cambiarEstado(5)
                              }
                            }
                          },
                          [_vm._v("Cambiar a Firmado")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  [5, 7].indexOf(_vm.form.estado) >= 0
                    ? _c("li", [
                        _c(
                          "a",
                          {
                            on: {
                              click: function($event) {
                                return _vm.cambiarEstado(6)
                              }
                            }
                          },
                          [_vm._v("Cambiar a Retenido")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  [5, 6].indexOf(_vm.form.estado) >= 0
                    ? _c("li", [
                        _c(
                          "a",
                          {
                            on: {
                              click: function($event) {
                                return _vm.cambiarEstado(7)
                              }
                            }
                          },
                          [_vm._v("Cambiar a Disponible")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  [7].indexOf(_vm.form.estado) >= 0
                    ? _c("li", [
                        _c(
                          "a",
                          {
                            on: {
                              click: function($event) {
                                return _vm.cambiarEstado(8)
                              }
                            }
                          },
                          [_vm._v("Cambiar a Pagado")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  [8].indexOf(_vm.form.estado) >= 0
                    ? _c("li", [
                        _c(
                          "a",
                          {
                            on: {
                              click: function($event) {
                                return _vm.cambiarEstado(9)
                              }
                            }
                          },
                          [_vm._v("Cambiar a Archivado")]
                        )
                      ])
                    : _vm._e()
                ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "content-box-header" }, [
      _c("div", { staticClass: "box-title" }, [
        _vm._v("Cambiar Estado de Comprobante de pago")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "box-description" }, [
        _vm._v("Formulario para cambiar estado de comprobante de pago")
      ])
    ])
  },
  function() {
  ...
  function() {
    ...
    return _c(
      ...
      [_vm._v("Opciones "), _c("span", { staticClass: "caret" })]
    )
  }
]
render._withStripped = true
                      ...
                      _c(
                        ...
                        [
                          ...
                          solicitud.estado === 3
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          [4, 5, 6, 7, 8].indexOf(solicitud.estado) >= 0
                            ? _c(
                                "router-link",
                                {
                                  attrs: {
                                    ...
                                    title:
                                      "Cambiar estado de comprobante de pago"
                                  }
                                },
                                [_c("i", { staticClass: "icon-share-alt" })]
                              )
