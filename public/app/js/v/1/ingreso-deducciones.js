...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    obtener: function obtener() {
      var self = this;
      self.loading = true;
      _api_ingresos_deducciones__WEBPACK_IMPORTED_MODULE_0__["default"].obtener(self.filter, function (data) {
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    attrs: {
                      to: { name: "listado-ingreso-deduccion" },
                      tag: "button"
                    }
                  },
                  [
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "content-box-header" }, [
          _c("div", { staticClass: "box-title" }, [
            _vm._v("Administrar ingresos y deducciones")
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "box-description" }, [
            _vm._v("Listado de ingreso y deducciones")
          ]),
          _vm._v(" "),
          _c(
            "div",
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  obtener: function obtener(data, cb, errorCb) {
    axios.post('rrhh/ingreso_deduccion/obtener', data).then(function (response) {
      if (response.data.status == 'success') {
        cb(response.data.result);
      } else {
        errorCb(response.data.result);
