...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.initLineChart(); //console.log(this.$auth.user()[0].usuario);
  }
});
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _vm.ajustesBasicos[1]
                ? [
                    _c("img", {
                      attrs: {
                        src: JSON.parse(
                          _vm.ajustesBasicos[1]
                            ? _vm.ajustesBasicos[1].valor
                            : "[]"
                        )[0]
                          ? JSON.parse(
                              _vm.ajustesBasicos[1]
              ...
              _vm.$auth.user()[0]
                ? [
                    _c("div", { staticClass: "user-name" }, [
                      _vm._v(
                        _vm._s(
                          _vm.$auth.user()[0].trabajador.primer_nombre +
                            " " +
                            _vm.$auth.user()[0].trabajador.primer_apellido +
                            " " +
                            (_vm.$auth.user()[0].trabajador.segundo_apellido
                              ? _vm.$auth.user()[0].trabajador.segundo_apellido
                              : "")
                        )
                      )
  ...
  function() {
    ...
    return _c("div", { staticClass: "messages" }, [
      _c("div", { staticClass: "icon" }, [
        _c("i", { staticClass: "pe-7s-chat" }),
        _vm._v(" "),
        _c("div", { staticClass: "count" }, [_vm._v("4")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "messages-box" }, [
        _c("div", { staticClass: "header" }, [_vm._v("Últimos mensajes")]),
        _vm._v(" "),
        _c("div", { staticClass: "content" }, [
          _c("a", { staticClass: "message-list", attrs: { href: "" } }, [
            _c("div", { staticClass: "user-image" }, [
              _c("img", {
                attrs: { src: "/public/app/images/logo-lubnica.jpg" }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "right-content" }, [
              _c("div", { staticClass: "name" }, [_vm._v("Carlos Cantarero")]),
              _vm._v(" "),
              _c("div", { staticClass: "text" }, [
                _vm._v("Ha realizado traslado de bodega")
              ])
            ])
          ]),
          _vm._v(" "),
          _c("a", { staticClass: "message-list", attrs: { href: "" } }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "right-content" }, [
              _c("div", { staticClass: "name" }, [_vm._v("Raúl Ordóñez")]),
              _vm._v(" "),
              _c("div", { staticClass: "text" }, [
                _vm._v("Ha consolidado saldos de contabilidad")
              ])
            ])
          ]),
          _vm._v(" "),
          _c("a", { staticClass: "message-list", attrs: { href: "" } }, [
            ...
            _c("div", { staticClass: "right-content" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "text" }, [
                _vm._v("Ha creado solicitud de cheque No. 34534")
              ])
            ])
          ]),
          _vm._v(" "),
          _c("a", { staticClass: "message-list", attrs: { href: "" } }, [
            ...
            _c("div", { staticClass: "right-content" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "text" }, [
                _vm._v("Ha aprobado solicitud de reembolso de factura.")
              ])
            ])
          ])
        ]),
        ...
        _c("div", { staticClass: "footer" }, [
          _c("a", { attrs: { href: "" } }, [_vm._v("Ver todos los mensajes")])
        ])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "user-image" }, [
      _c("div", { staticClass: "image" }, [
        _c("img", { attrs: { src: "/public/app/images/logo-lubnica.jpg" } })
      ])
    ])
  },
  function() {
