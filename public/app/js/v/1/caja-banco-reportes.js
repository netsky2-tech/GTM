                ...
                _c(
                  ...
                  [
                    ...
                    _c("datepicker", {
                      ...
                      on: { selected: _vm.seleccionarFechaInicialRetenciones },
                      model: {
              ...
              _c("div", { staticClass: "col-sm-4" }, [
                _c(
                  ...
                  [
                    ...
                    _c("datepicker", {
                      attrs: { format: _vm.format, language: _vm.es },
                      on: { selected: _vm.seleccionarFechaFinalRetenciones },
                      model: {
              ...
              _c("div", { staticClass: "col-sm-4" }, [
                _c(
                  ...
                  [
                    ...
                    _c("datepicker", {
                      attrs: { format: _vm.format, language: _vm.es },
                      on: { selected: _vm.seleccionarFechaInicialCheques },
                      model: {
                    ...
                    "select",
                    {
                      ...
                      on: {
                        change: function($event) {
                          ...
                          _vm.formatoChequesEstados = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        }
                      }
                    ...
                    "select",
                    {
                      ...
                      on: {
                        change: function($event) {
                          ...
                          _vm.formatoChequeAnulado = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        }
                      }
