...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    obtenerPadres: function obtenerPadres() {
      var self = this;
      _api_menu__WEBPACK_IMPORTED_MODULE_0__["default"].obtenerPadres(self.filter, function (data) {
        self.menu_padres = data.rows;
      }, function (err) {
        console.log(err);
      });
    }
  ...
  mounted: function mounted() {
    this.obtenerMenuEspecifico(), this.obtenerSecciones(), this.obtenerPadres();
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    seleccionarMenu: function seleccionarMenu(menu) {
      this.menuActivo = menu.id_menu; //this.obtenerPermisos(menu.id_menu)

      menu.sub_menus.forEach(function (subMenus, key) {
        menu.sub_menus[key].secuenciaPadre = menu.secuencia;
      });
      this.form.subMenus = menu.sub_menus;
    },
    obtenerMenus: function obtenerMenus() {
      var self = this;
      _api_menu__WEBPACK_IMPORTED_MODULE_0__["default"].obtenerMenusOrdenados(function (data) {
        self.menus = data;
      }, function (err) {
        console.log(err);
      });
        ...
        _c("div", { staticClass: "content-box" }, [
          ...
          _c("form", [
            ...
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col-sm-6" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "" } }, [_vm._v("Sección")]),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.form.menu_seccion,
                          expression: "form.menu_seccion"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { disabled: "" },
                    ...
                    [
                      ...
                      _vm._l(_vm.secciones, function(seccion) {
                        return _c("option", {
                          key: seccion.menu_seccion,
                          domProps: {
                            textContent: _vm._s(seccion.menu_seccion)
                          }
                        })
                      })
                    ],
                  ...
                  _c(
                    "ul",
                    { staticClass: "error-messages" },
                    _vm._l(_vm.errorMessages.menu_seccion, function(message) {
                      return _c("li", {
                        key: message,
                        domProps: { textContent: _vm._s(message) }
                      })
              ...
              _c("div", { staticClass: "col-sm-6" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "" } }, [_vm._v("Menu Padre")]),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.form.id_menu_padre,
                          expression: "form.id_menu_padre"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { disabled: "" },
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm._l(_vm.menu_padres, function(menu_padre) {
                        return _c("option", {
                          key: menu_padre.id_menu,
                          domProps: {
                            value: menu_padre.id_menu,
                            textContent: _vm._s(menu_padre.menu_padre)
                          }
                        })
                      })
                    ],
                  ...
                  _c(
                    "ul",
                    { staticClass: "error-messages" },
                    _vm._l(_vm.errorMessages.menu_padre, function(message) {
                      return _c("li", {
                        key: message,
                        domProps: { textContent: _vm._s(message) }
                      })
                ...
                [
                  _vm._l(_vm.menus, function(menu) {
                    return _c(
                      ...
                      {
                        key: menu.id_menu,
                        class: _vm.menuActivoClass(menu),
                        on: {
                          click: function($event) {
                            return _vm.seleccionarMenu(menu)
                          }
                        }
                      },
                      [
                        _c("td", { staticClass: "text-center" }, [
                          ...
                          _vm._v(_vm._s(menu.nombre_menu))
                        ])
                      ]
                    )
                  }),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("thead", [
      _c("tr", [_c("th", { staticClass: "text-center" }, [_vm._v("Menu")])])
    ])
  },
  function() {
    var _vm = this
