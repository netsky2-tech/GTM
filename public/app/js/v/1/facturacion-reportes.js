                        ...
                        change: [
                          function($event) {
                            ...
                            if (Array.isArray($$a)) {
                              ...
                              if ($$el.checked) {
                                $$i < 0 &&
                                  (_vm.todas_sucursales = $$a.concat([$$v]))
                              } else {
                                $$i > -1 &&
                ...
                ? _c("div", { staticClass: "col-sm-9" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c(
                        ...
                        [
                          _c("typeahead", {
                            staticStyle: { width: "100%" },
                            attrs: {
                              initial: _vm.cliente_estadocuentadetalladoR2,
                              trim: 80,
                      ...
                      _c(
                        ...
                        { staticClass: "error-messages" },
                        _vm._l(
                          _vm.errorMessages.id_cliente_estadocuentadetalladoR2,
                          function(message) {
                            return _c("li", {
                              key: message,
                              domProps: { textContent: _vm._s(message) }
                        ...
                        change: [
                          function($event) {
                            ...
                            if (Array.isArray($$a)) {
                              ...
                              if ($$el.checked) {
                                $$i < 0 &&
                                  (_vm.todos_vendedores = $$a.concat([$$v]))
                              } else {
                                $$i > -1 &&
                ...
                ? _c("div", { staticClass: "col-sm-9" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c(
                        ...
                        [
                          _c("typeahead", {
                            staticStyle: { width: "100%" },
                            attrs: {
                              initial: _vm.vendedor_estadocuentadetalladoR2,
                              trim: 80,
                      ...
                      _c(
                        ...
                        { staticClass: "error-messages" },
                        _vm._l(
                          _vm.errorMessages.id_vendedor_estadocuentadetalladoR2,
                          function(message) {
                            return _c("li", {
                              key: message,
                              domProps: { textContent: _vm._s(message) }
                    ...
                    "select",
                    {
                      ...
                      on: {
                        change: function($event) {
                          ...
                          _vm.tipoEstadoCuentaDetallado = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        }
                      }
                        ...
                        change: [
                          function($event) {
                            ...
                            if (Array.isArray($$a)) {
                              ...
                              if ($$el.checked) {
                                $$i < 0 &&
                                  (_vm.todos_vendedoresR3 = $$a.concat([$$v]))
                              } else {
                                $$i > -1 &&
                ...
                ? _c("div", { staticClass: "col-sm-9" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c(
                        ...
                        [
                          _c("typeahead", {
                            staticStyle: { width: "100%" },
                            attrs: {
                              initial: _vm.vendedor_estadocuentadetalladoR3,
                              trim: 80,
                              url: _vm.vendedoresBusquedaURL
                            },
                            on: {
                      ...
                      _c(
                        ...
                        { staticClass: "error-messages" },
                        _vm._l(
                          _vm.errorMessages.id_vendedor_estadocuentadetalladoR3,
                          function(message) {
                            return _c("li", {
                              key: message,
                              domProps: { textContent: _vm._s(message) }
              ...
              _c("div", { staticClass: "col-sm-4" }, [
                _c(
                  "button",
                  {
                    staticClass: "btn btn-primary btn-imprimir",
                    attrs: { type: "button" },
                    on: { click: _vm.descargarReporteComisionesAsignacion }
                  },
                  [_vm._v("Imprimir\n\t\t\t\t\t\t")]
                )
              ])
                        ...
                        change: [
                          function($event) {
                            ...
                            if (Array.isArray($$a)) {
                              ...
                              if ($$el.checked) {
                                $$i < 0 &&
                                  (_vm.todos_vendedoresR4 = $$a.concat([$$v]))
                              } else {
                                $$i > -1 &&
                ...
                ? _c("div", { staticClass: "col-sm-9" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c(
                        ...
                        [
                          _c("typeahead", {
                            staticStyle: { width: "100%" },
                            attrs: {
                              initial: _vm.vendedor_estadocuentadetalladoR4,
                              trim: 80,
                              url: _vm.vendedoresBusquedaURL
                            },
                            on: {
                      ...
                      _c(
                        ...
                        { staticClass: "error-messages" },
                        _vm._l(
                          _vm.errorMessages.id_vendedor_estadocuentadetalladoR4,
                          function(message) {
                            return _c("li", {
                              key: message,
                              domProps: { textContent: _vm._s(message) }
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "option",
                        {
                          attrs: { value: "ReporteVentasPorVendedorComisiones" }
                        },
                      ...
                      _c(
                        ...
                        {
                          attrs: {
                            value: "ReporteNotasCreditoPorVendedorComisiones"
                          }
                        },
                      ...
                      _c(
                        ...
                        {
                          attrs: {
                            value: "ReporteNotasDebitoPorVendedorComisiones"
                          }
                        },
              ...
              _c("div", { staticClass: "col-sm-3" }, [
                _c(
                  ...
                  [
                    ...
                    _c("datepicker", {
                      attrs: { format: _vm.format, language: _vm.es },
                      on: { selected: _vm.seleccionarFechaInicialComisionR4 },
                      model: {
              ...
              _c("div", { staticClass: "col-sm-3" }, [
                _c(
                  ...
                  [
                    ...
                    _c("datepicker", {
                      attrs: { format: _vm.format, language: _vm.es },
                      on: { selected: _vm.seleccionarFechaCorteComisionR4 },
                      model: {
                    ...
                    "select",
                    {
                      ...
                      on: {
                        change: function($event) {
                          ...
                          _vm.formatoAsignacionesComisionR4 = $event.target
                            .multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        }
