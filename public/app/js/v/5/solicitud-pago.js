    ...
    nuevaContabilizacion: function nuevaContabilizacion() {
      ...
      _api_solicitudes_pago__WEBPACK_IMPORTED_MODULE_2__["default"].nuevaContabilizacion({
        ...
        if (data.solicitud.estado === 2) {
          ...
          self.form.t_cambio = Number(data.t_cambio.tasa);
          self.obtenerCodigo(); //self.detalleForm.moneda_x = self.monedas[0];
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cambiarEstadoSolicitudPago: function cambiarEstadoSolicitudPago(estado, id_solicitud_pago) {
              ...
              _c("div", { staticClass: "col-sm-3" }, [
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: {
                      disabled: !_vm.form.cuenta_bancaria
                ...
                _vm._l(_vm.solicitudes, function(solicitud, key) {
                  return [
                    _c("tr", { key: solicitud.id_solicitud_pago }, [
                      ...
                      _c("td", [_vm._v(_vm._s(solicitud.concepto))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(solicitud.fecha_solicitud))]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(solicitud.moneda_solicitud.descripcion))
                      ]),
    ...
    [
      _c("div", { staticClass: "panel-heading" }, [
        _c("span", { staticClass: "panel-title" }, [
          _vm._v(
            "Solicitud de Pago No2.: " + _vm._s(_vm.form.id_solicitud_pago)
          )
        ]),
        _vm._v(" "),
                ...
                _c("table", { staticClass: "document-summary" }, [
                  _c("tbody", [
                    ...
                    _c("tr", [
                      ...
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(_vm.formatDate(_vm.form.fecha_solicitud)))
                      ])
                    ]),
                    _vm._v(" "),
                    _c("tr", [
                      _c("td", [_vm._v("Fecha Autorización:")]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(
                          _vm._s(
                            _vm.form.f_aprobacion
                              ? _vm.formatDate(_vm.form.f_aprobacion)
                              : "N/D"
                          )
                        )
                      ])
