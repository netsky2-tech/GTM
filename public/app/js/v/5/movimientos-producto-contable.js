                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.costo_promediox,
                    expression: "costo_promediox"
                  }
                ],
                staticClass: "form-control",
                attrs: { readonly: "", placeholder: "Unidades" },
                domProps: { value: _vm.costo_promediox },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.costo_promediox = $event.target.value
                  }
                }
              })
            ])
                ...
                _vm._l(_vm.movimientos, function(movimiento, index) {
                  return _c("tr", { key: movimiento.id_movimiento }, [
                    ...
                    _c("td", { staticClass: "text-center" }, [
                      _c("strong", [
                        _vm._v(
                          "C$ " + _vm._s(_vm.calcular_saldo(movimiento, index))
                        )
                      ])
                    ])
                  ])
            ...
            _c("tfoot", [
              _c("tr", [
                ...
                _c("td", { staticClass: "text-center" }, [
                  _c("strong", [
                    _vm._v(
                      "C$ " + _vm._s(_vm._f("formatMoney")(_vm.total_saldox, 2))
                    )
                  ])
                ])
              ])
