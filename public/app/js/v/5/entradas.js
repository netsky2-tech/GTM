...
/* harmony import */ var _api_entradas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../api/entradas */ "./resources/app/api/entradas.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    obtenerEntrada: function obtenerEntrada() {
      ...
      var self = this;
      _api_entradas__WEBPACK_IMPORTED_MODULE_3__["default"].obtenerEntrada({
    ...
    obtenerTodosProveedores: function obtenerTodosProveedores() {
      var self = this;
      proveedor.obtenerTodosProveedores(function (data) {
    ...
    agregarDetalle: function agregarDetalle() {
      ...
      if (this.detalleForm.productox) {
        if (this.detalleForm.cantidad_solicitada > 0 && this.detalleForm.precio_unitario > 0) {
          var i = 0;
          var keyx = 0;
          ...
          if (i === 0) {
            ...
            this.$swal.fire({
              ...
              if (result.value) {
                ...
                self.form.entrada_productos[keyx].precio_unitario = self.detalleForm.precio_unitario;
                _this2.detalleForm.productox = '';
                _this2.detalleForm.cantidad_solicitada = 0;
                _this2.detalleForm.precio_unitario = 0;
          ...
          alertify.warning("Los valores para cantidad_solicitada y precio unitario deben ser mayores que cero", 5);
        }
      } else {
    ...
    actualizar: function actualizar() {
      ...
      if (self.form.es_borrador === false) {
        self.$swal.fire({
          ...
          if (result.value) {
            _api_entradas__WEBPACK_IMPORTED_MODULE_3__["default"].actualizar(self.form, function (data) {
  ...
  methods: {
    ...
    obtenerEntrada: function obtenerEntrada() {
      ...
      _api_entradas__WEBPACK_IMPORTED_MODULE_0__["default"].obtenerEntrada({
        ...
        self.form = data.entrada; //console.log(data.traslados);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    obtenerProductosValidos: function obtenerProductosValidos() {
      var self = this;
      _api_productos__WEBPACK_IMPORTED_MODULE_0__["default"].obtenerProductosValidos(function (data) {
        self.productos = data; //self.detalleForm.productox=self.productos[0];
      }, function (err) {
        console.log(err);
      });
    },
      ...
      if (this.detalleForm.productox) {
        if (this.detalleForm.cantidad > 0 && this.detalleForm.precio_unitario > 0) {
          ...
          if (i === 0) {
            ...
            this.detalleForm.subtotal = 0;
            this.detalleForm.total = 0;
            this.$refs.bateria.$el.focus(); // console.log(this.detalleForm.productox);
            // this.$refs.bateria.$el.focus();
          } else {
            this.$swal.fire({
              title: 'El producto ya existe en el detalle, desea sumar la nueva cantidad al monto existente?',
              ...
              if (result.value) {
                ...
                _this.detalleForm.precio_unitario = 0;
    ...
    registrar: function registrar() {
      ...
      if (self.form.es_borrador === false) {
        self.$swal.fire({
          ...
          if (result.value) {
            _api_entradas__WEBPACK_IMPORTED_MODULE_4__["default"].registrar(self.form, function (data) {
              ...
              _this2.$swal.fire('Entrada Registrada!', 'La Entrada fue Registrada correctamente.', 'success');
        ...
        _api_entradas__WEBPACK_IMPORTED_MODULE_4__["default"].registrar(self.form, function (data) {
          // alertify.success("Entrada registrada correctamente",5);
          _this2.$swal.fire('Borrador de Entrada Registrado!', 'La Entrada fue Registrada correctamente.', 'success');
        ...
        _c("div", { staticClass: "content-box" }, [
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-sm-3" }, [
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("v-select", {
                    attrs: { options: _vm.tipos_entrada, label: "descripcion" },
                    model: {
                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(_vm.form, "codigo_entrada", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
            ...
            _c("div", { staticClass: "col-sm-3" }, [
              _c("div", { staticClass: "form-group" }, [
                _c("label", { attrs: { for: "" } }, [
                  _vm._v("Número documento de entrada")
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
            ...
            _c("div", { staticClass: "col-sm-3" }, [
              _c("div", { staticClass: "form-group" }, [
                ...
                _c(
                  "ul",
                  { staticClass: "error-messages" },
                  _vm._l(_vm.errorMessages.precio_unitariox, function(message) {
                    return _c("li", {
                      key: message,
                      domProps: { textContent: _vm._s(message) }
                    })
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-sm-12" }, [
              _c(
                "ul",
                { staticClass: "error-messages" },
                _vm._l(_vm.errorMessages.entrada_productos, function(message) {
                  return _c("li", {
                    key: message,
                    domProps: { textContent: _vm._s(message) }
                  })
                        ...
                        _c("tr", [
                          ...
                          _c("td", [
                            ...
                            _c(
                              ...
                              _vm._l(
                                _vm.errorMessages[
                                  "entrada_productos." + index + ".id_producto"
                                ],
                                function(message) {
                                  return _c("li", {
                                    key: message,
                    ...
                    _c("tr", { key: entrada.id_entrada }, [
                      ...
                      _c(
                        ...
                        [
                          entrada.estado === 1
                            ? [
                                [1].indexOf(Number(entrada.id_tipo_entrada)) < 0
                                  ? [
                                      _c(
                                        "router-link",
                                        {
                                          ...
                                          directives: [
                                            {
                                              name: "tooltip",
                                              rawName: "v-tooltip",
                                              value: "Recibir Compra",
                                              expression: "'Recibir Compra'"
                                            }
                                          ],
                                          attrs: {
                                            to: {
          ...
          _c(
            "a",
            {
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.descargarReporteEntrada()
                }
              }
            },
                            ...
                            "router-link",
                            {
                              ...
                              attrs: {
                                to: {
                                  ...
                                  params: {
                                    id_proveedor: _vm.form.id_proveedor
                                  }
                                },
                                target: "_blank"
                              }
                  ...
                  _c("div", { staticClass: "document-body" }, [
                    _c("table", { staticClass: "document-table" }, [
                      ...
                      _c(
                        "tbody",
                        [
                          _vm._l(_vm.form.entrada_productos, function(item2) {
                            return [
                              item2.entrada_producto_baterias
                                ? [
                                    _vm._l(
                                      item2.entrada_producto_baterias,
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "align-center" }, [_vm._v("Cantidad Recibida")])
      ])
    ])
  },
  function() {
