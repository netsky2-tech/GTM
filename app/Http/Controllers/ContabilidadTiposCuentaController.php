...
class ContabilidadTiposCuentaController extends Controller
{
    /**
    ...
    public function obtenerTiposCuenta(Request $request, ContabilidadTiposCuenta $tipos_cuenta)
    {
    ...
    public function obtenerTodosTiposCuenta(Request $request, ContabilidadTiposCuenta $tipos_cuenta)
    {
        $tipos_cuenta = ContabilidadTiposCuenta::all();
        return response()->json([
            'status' => 'success',
            'result' => $tipos_cuenta,
            'messages' => null
    ...
    public function obtenerTipoCuenta(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $tipo_cuenta = ContabilidadTiposCuenta::where('id_tipo_cuenta',$request->id_tipo_cuenta)->with('tipoCuentaEstadoFinanciero')->get();
    ...
    public function actualizar(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules);
        if (!$validator->fails()) {
            $tipo_Cuenta = ContabilidadTiposCuenta::find($request->id_tipo_cuenta);
