...
class PublicImpuestosController extends Controller
{
    /**
    ...
    public function obtener(Request $request, PublicImpuestos $impuestos)
    {
    ...
    public function obtenerTodos(Request $request, PublicImpuestos $impuestos)
    {
        $impuestos = PublicImpuestos::orderby('id_impuesto')->get();
        return response()->json([
            'status' => 'success',
            'result' => $impuestos,
            'messages' => null
    ...
    public function obtenerImpuesto(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $impuestos = PublicImpuestos::find($request->id_impuesto);
    ...
    public function registrar(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules);
        if (!$validator->fails()) {
            $impuesto = new PublicImpuestos;
            $impuesto->descripcion = $request->descripcion;
            $impuesto->tasa = $request->tasa;
            $impuesto->u_grabacion = Auth::user()->usuario;
            $impuesto->estado = 1;
            $impuesto->save();
    ...
    public function actualizar(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules);
        if (!$validator->fails()) {
            $impuesto = PublicImpuestos::find($request->id_impuesto);
            $impuesto->descripcion = $request->descripcion;
            $impuesto->tasa = $request->tasa;
            $impuesto->u_modificacion = Auth::user()->usuario;
            $impuesto->save();
