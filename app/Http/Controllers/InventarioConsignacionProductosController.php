...
use App\Models\InventarioConsignacionProductosVista;
use PHPJasper\PHPJasper;
use Validator,Auth,DB;
use Illuminate\Http\Request;

class InventarioConsignacionProductosController extends Controller
{
    ...
    public function obtenerPorCliente(Request $request, InventarioConsignacionProductosVista $movimientos)
    {
        $rules = [
    ...
    public function obtenerTodos(Request $request, InventarioConsignacionProductosVista $movimientos)
    {
