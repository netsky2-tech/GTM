...
use App\Models\InventarioTiposProductos;
...
class InventarioTiposProductosController extends Controller
{
    /**
     ...
     * @param InventarioTiposProductos $datos
     * @return  json(array)
     */

    public function obtener(Request $request, InventarioTiposProductos $datos)
    {
    ...
    public function obtenerTodas(Request $request, InventarioTiposProductos $datos)
    {
        $conf = session()->get('id_empresa');
        $datos = InventarioTiposProductos::where('id_empresa', '=', $conf)->orderby('id_tipo_producto')->get();
        return response()->json([
            'status' => 'success',
            'result' => $datos,
            'messages' => null
    ...
    public function obtenerTipoProducto(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $datos = InventarioTiposProductos::find($request->id_tipo_producto);
