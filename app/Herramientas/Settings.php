...
class Settings {
    ...
    {
        $found = $this->db()
            ->where('identificador', $key)->select('id_ajuste','identificador','valor')
            ->first();
    ...
    {
        $found = $this->db()
            ->where('identificador', 'uploaded_logo')->select('id_ajuste','identificador','valor')
            ->first();
    ...
    {
        $found = $this->db()
            ->where('identificador', 'uploaded_icon')->select('id_ajuste','identificador','valor')
            ->first();
