...
class InventarioTransformacionDetalleEntrada extends Model
{
    protected $table = 'inventario.detalle_transformaciones_entradas';
    protected $primaryKey='id_detalle_transformacion_entrada';
     /**
    ...
    protected $fillable = ['codigo','nombre_producto','descripcion','costo_estandar','precio_sugerido','existencia_Min','activo'];
    ...
    public function obtenerTransformaciones($request)
    {
        ...
        if (!empty($request->search['field'])) {
            ...
            $productos->with('productosBodega');
  ...
  /*  public function productoDetallesBaterias()
   ...
   /* public function impuestoProducto()
    ...
    public function productosEntrada()
    {
        return $this->hasMany('App\Models\InventarioProductos','id_producto','id_producto')
            ->select(['id_producto',DB::raw("CONCAT('(',inventario.productos.codigo_sistema,')',' ',inventario.productos.nombre_comercial)AS text")]);;
    ...
    public function presentacionEntrada(){
        return $this->hasMany('App\Models\InventarioPresentacion','id_presentacion','id_presentacion_entrada')
            ->select('id_presentacion', 'codigo','escalar','id_origen');
    }
