...
class InventarioTransformacionDetalle extends Model
{
    protected $table = 'inventario.detalle_transformaciones_salidas';
    protected $primaryKey='id_detalle_transformacion';
     /**
  ...
  /*  public function productoDetallesBaterias()
   ...
   /* public function impuestoProducto()
    ...
    public function presentacionSalida(){
        return $this->hasMany('App\Models\InventarioPresentacion','id_presentacion','id_presentacion_salida')
